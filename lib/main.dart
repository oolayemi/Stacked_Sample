  ...
  Widget build(BuildContext context) {
    return LifeCycleManager(
      child: MaterialApp(
          ...
          home: const MyHomePage(title: 'title',) //MainView()//MyHomePage(title: 'CashMore',),
        // initialRoute: viewModel.shouldShowOnboard ? Routes.onboarding : Routes.startupViewRoute,
      ),
    );
    // return MaterialApp(
    //   title: 'Flutter Demo',
